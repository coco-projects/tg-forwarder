<?php
    ...
    $config = [
        ...
        'baseBotUrl'  => 'http://2.00.151.132:40100/bot',
        'webhookBase' => 'https://bottest.00000.com/index.php',
    ...
    $hash = 'd5d84c97f093c2664f8183690d4b000';

    $imagePath = __DIR__ . '/examples/media/1.jpg';
//	tktest002 @tktest002

    $token   = '8656070000:AAHxBUslqpxjXLHXSf2qQKb-TA6OEIHD000';
    $channel = -1003819900000;
    $group   = -1003807130000;

    $chatId = 5667920492;
    $fileId = 'AgACAgUAAxUAAWmux6C3PBY5PoFt4svwYHsZC3FTAAKSD2sbKvtwVXv82mQwM925AQADAgADYQA0000';
